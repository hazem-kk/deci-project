...
async function initGoogleMap(){
  ...
  if(!key||key==='YOUR_GOOGLE_MAPS_API_KEY'){status.innerHTML='<span class="map-status-dot map-status-dot--warn"></span><span>Add Google Maps API key</span>';return null;}
  googleMapInitPromise=new Promise((resolve,reject)=>{
    ...
    googleMap=new Map(document.getElementById('googleMap'),{center:{lat:30.0444,lng:31.2357},zoom:12,mapId:'DEMO_MAP_ID',mapTypeControl:false,streetViewControl:false,fullscreenControl:false,clickableIcons:true,gestureHandling:'greedy',styles:[
      {elementType:'geometry',stylers:[{color:'#0d1220'}]},{elementType:'labels.text.fill',stylers:[{color:'#c4b5fd'}]},{elementType:'labels.text.stroke',stylers:[{color:'#0d1220'}]},
      {featureType:'administrative',elementType:'geometry.stroke',stylers:[{color:'#34304f'}]},{featureType:'road',elementType:'geometry',stylers:[{color:'#20263a'}]},
      {featureType:'road',elementType:'geometry.stroke',stylers:[{color:'#111827'}]},{featureType:'road',elementType:'labels.text.fill',stylers:[{color:'#8f99b8'}]},
      {featureType:'water',elementType:'geometry',stylers:[{color:'#090e19'}]},{featureType:'poi',elementType:'geometry',stylers:[{color:'#171c2c'}]},{featureType:'poi',elementType:'labels.text.fill',stylers:[{color:'#9aa4c0'}]}]});
